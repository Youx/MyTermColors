...
@interface TTView : TTAccessibleView <TTBlinking, NSTextInput>
{
	...
	CDAnonymousStruct5 *_glyphsBuffer;
	CDAnonymousStruct5 *_advancesBuffer;
	CDAnonymousStruct5 *_indicesBuffer;
	...
	CDAnonymousStruct4 _initialSelectionPoint;
	CDAnonymousStruct4 _endSelectionPoint;
	CDAnonymousStruct4 _previousSelectionStart;
	CDAnonymousStruct4 _previousSelectionEnd;
	NSCursor *_mouseCursor;
	BOOL _dragAndDropIsActive;
	unsigned long long _printRange;
	CDAnonymousStruct6 _ttaxLastCursorPosition;
	unsigned long long _ttaxLastLineCount;
	BOOL _hasMarkedText;
	BOOL _markedTextHasAttributes;
	NSAttributedString *_markedText;
	CDAnonymousStruct6 _markedTextAnchor;
...
- (void)updateBlinker;
- (BOOL)isInverted;
- (CDAnonymousStruct5 *)createUTF16FromUTF8:(CDAnonymousStruct5 *)arg1;
...
- (struct CGPoint)pointForDisplayPosition:(CDAnonymousStruct1)arg1;
- (CDAnonymousStruct1)displayPositionForPoint:(struct CGPoint)arg1;
- (void)handleAlertCompletion;
- (id)dirtyLines;
- (BOOL)scrollingIsPinned;
- (void)setScrollingIsPinned:(BOOL)arg1;
- (id)pane;
